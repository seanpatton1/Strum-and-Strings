...
urlpatterns = [
    ...
    path(
        'admin-dashboard/orders/<int:order_id>/edit/',
        views.admin_edit_order,
        name='admin_edit_order'
        ),
    path(
        'newsletter/save-email/',
        views.save_newsletter_email,
        name='save_newsletter_email'
        ),
    path(
    ...
    path(
        'admin-dashboard/newsletter/<int:subscriber_id>/edit/',
    ...
    path(
        ...
        views.check_newsletter_email,
        name='check_newsletter_email'
    ),

    path(
        'admin-dashboard/newsletter/<int:subscriber_id>/delete/',
